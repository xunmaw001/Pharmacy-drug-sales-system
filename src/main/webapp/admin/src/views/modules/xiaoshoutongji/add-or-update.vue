    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药品名称" prop="yaopinmingcheng">
          <el-select v-model="ruleForm.yaopinmingcheng" placeholder="请选择药品名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售额" prop="xiaoshoue">
          <el-input v-model="ruleForm.xiaoshoue" 
              placeholder="销售额" clearable  :readonly="ro.xiaoshoue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售额" prop="xiaoshoue">
              <el-input v-model="ruleForm.xiaoshoue" 
                placeholder="销售额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成本额" prop="chengbene">
          <el-input v-model="ruleForm.chengbene" 
              placeholder="成本额" clearable  :readonly="ro.chengbene"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成本额" prop="chengbene">
              <el-input v-model="ruleForm.chengbene" 
                placeholder="成本额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    lirun: {
      get: function () {
        return 0+parseFloat(this.ruleForm.xiaoshoue==""?0:this.ruleForm.xiaoshoue)-parseFloat(this.ruleForm.chengbene==""?0:this.ruleForm.chengbene) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshoue = true;
          ...
          if(o=='chengbene'){
            this.ruleForm.chengbene = obj[o];
	    this.ro.chengbene = true;
            continue;
          }
          if(o=='lirun'){

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进货总额" prop="jinhuozonge">
          <el-input v-model="ruleForm.jinhuozonge" 
              placeholder="进货总额" clearable  :readonly="ro.jinhuozonge"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进货总额" prop="jinhuozonge">
              <el-input v-model="ruleForm.jinhuozonge" 
                placeholder="进货总额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售收入" prop="xiaoshoushouru">
          <el-input v-model="ruleForm.xiaoshoushouru" 
              placeholder="销售收入" clearable  :readonly="ro.xiaoshoushouru"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售收入" prop="xiaoshoushouru">
              <el-input v-model="ruleForm.xiaoshoushouru" 
                placeholder="销售收入" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    chunlirun: {
      get: function () {
        return 0-parseFloat(this.ruleForm.jinhuozonge==""?0:this.ruleForm.jinhuozonge)+parseFloat(this.ruleForm.xiaoshoushouru==""?0:this.ruleForm.xiaoshoushouru) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tongjibianhao = true;
          ...
          if(o=='jinhuozonge'){
            this.ruleForm.jinhuozonge = obj[o];
	    this.ro.jinhuozonge = true;
            continue;
          }
          if(o=='xiaoshoushouru'){
            this.ruleForm.xiaoshoushouru = obj[o];
	    this.ro.xiaoshoushouru = true;
            continue;
          }
          if(o=='chunlirun'){
